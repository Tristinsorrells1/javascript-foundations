...
it('has a great name', function() {
  ...
  it('checks for an assistant', function() {
...
it('can have a diff fav accessory', function() {
  ...
  it('performTrick with dove', function() {
  ...
  it('confidencePercentage', function() {
    var magician = new Magician({ name: 'Leta' });

    assert.equal(magician.confidencePercentage, 10);
  });

it('perform trick and get more confident', function() {
    var magician = new Magician({ name: 'Leta' });
  ...
  it('performShowStopper', function() {
...
it('performShowStopper with assistant', function() {
